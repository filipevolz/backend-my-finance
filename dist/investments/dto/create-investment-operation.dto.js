...
exports.CreateInvestmentOperationDto = CreateInvestmentOperationDto;
__decorate([
    (0, class_validator_1.IsNotEmpty)({ message: 'Ativo é obrigatório' }),
    (0, class_validator_1.IsString)({ message: 'Ativo deve ser uma string' }),
    __metadata("design:type", String)
], CreateInvestmentOperationDto.prototype, "asset", void 0);
__decorate([
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsString)({ message: 'Classe do ativo deve ser uma string' }),
    __metadata("design:type", String)
], CreateInvestmentOperationDto.prototype, "assetClass", void 0);
__decorate([
    (0, class_validator_1.IsNotEmpty)({ message: 'Tipo de operação é obrigatório' }),
    (0, class_validator_1.IsEnum)(investment_operation_entity_1.OperationType, { message: 'Tipo de operação inválido' }),
    __metadata("design:type", String)
], CreateInvestmentOperationDto.prototype, "type", void 0);
__decorate([
    (0, class_validator_1.IsNotEmpty)({ message: 'Data é obrigatória' }),
    (0, class_validator_1.IsDateString)({}, { message: 'Data inválida' }),
    __metadata("design:type", String)
], CreateInvestmentOperationDto.prototype, "date", void 0);
__decorate([
...
], CreateInvestmentOperationDto.prototype, "quantity", void 0);
__decorate([
    ...
    __metadata("design:type", Number)
], CreateInvestmentOperationDto.prototype, "price", void 0);
__decorate([
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsString)({ message: 'Moeda deve ser uma string' }),
    __metadata("design:type", String)
], CreateInvestmentOperationDto.prototype, "currency", void 0);
__decorate([
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsString)({ message: 'Corretora deve ser uma string' }),
    __metadata("design:type", String)
], CreateInvestmentOperationDto.prototype, "broker", void 0);
__decorate([
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsString)({ message: 'Observações deve ser uma string' }),
    __metadata("design:type", String)
], CreateInvestmentOperationDto.prototype, "notes", void 0);
//# sourceMappingURL=create-investment-operation.dto.js.map