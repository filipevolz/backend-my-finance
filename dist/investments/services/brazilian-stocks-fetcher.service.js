                    ...
                    if (existing) {
                        ...
                        try {
                            ...
                            if (saveError.code === '23505' ||
                                ...
                                if (existing) {
                                    existing.assetName =
                                        stockData.assetName || existing.assetName;
                                    existing.legalName =
                                        stockData.legalName || existing.legalName;
                                    existing.sector = stockData.sector || existing.sector;
                                    existing.subSector =
                                        stockData.subSector || existing.subSector;
                                    existing.segment = stockData.segment || existing.segment;
                                    existing.assetType =
                                        stockData.assetType || existing.assetType;
                                    existing.pic = stockData.pic || existing.pic;
                                    existing.marketString = 'Bovespa';
                                    existing.assetGroup = 'STOCK';
                                    await this.assetRepository.save(existing);
